...
<div ${multi.attributes} data-original-count="${fn:length(multi.values)}" data-multi-name="${multi.name}" data-allow-reorder="${multi.allowReorder }" data-base-name="${multi.baseName}">
